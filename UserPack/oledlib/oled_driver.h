...
#define OLED_SCLK_Clr() HAL_GPIO_WritePin(GPIOB, SCK_Pin, GPIO_PIN_RESET)//SCL=0
#define OLED_SCLK_Set() HAL_GPIO_WritePin(GPIOB, SCK_Pin, GPIO_PIN_SET)//SCL=1

#define OLED_SDIN_Clr() HAL_GPIO_WritePin(GPIOB, SDA_Pin, GPIO_PIN_RESET)//SDA=0
#define OLED_SDIN_Set() HAL_GPIO_WritePin(GPIOB, SDA_Pin, GPIO_PIN_SET)//SDA=1
...
void OLED_FILL_PART(unsigned char BMP[],int x0,int y0,int x1,int y1);
